      ...
      <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
          ...
          <div className="flex sm:hidden items-center gap-1">
            {cert.status === 'failed' && (
              <button
                ...
                className="p-2 text-[#FF5722] dark:text-[#FF7043] hover:bg-subtle rounded min-h-[36px] min-w-[36px] flex items-center justify-center"
            ...
            <button
              ...
              className="p-2 text-secondary hover:text-red-600 hover:bg-subtle rounded transition-colors min-h-[36px] min-w-[36px] flex items-center justify-center"
        ...
        <div className="flex-1 min-w-0 w-full">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 justify-between">
            <div className="min-w-0">
              <p className="font-heading text-base sm:text-lg font-bold text-app break-words">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {!expanded && allSkills.length > 6 && (
                  <button
                    ...
                    className="px-2.5 py-1 text-[11px] font-medium bg-subtle text-secondary flex items-center gap-1 border border-app rounded"
                  >
        ...
        <div className="hidden sm:flex gap-1 flex-shrink-0">
          {cert.status === 'failed' && (
            <button
              onClick={() => onReprocess(cert.id)}
              className="p-2 text-[#FF5722] dark:text-[#FF7043] hover:bg-subtle rounded"
              title="Retry verification"
            >
          ...
          <button
            onClick={() => onDelete(cert.id)}
            className="p-2 text-secondary hover:text-red-600 hover:bg-subtle rounded transition-colors"
            title="Delete certificate"
          >
